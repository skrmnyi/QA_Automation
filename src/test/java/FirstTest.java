...
public class FirstTest {
  ...
  public void someChecks() {
    ...
    signInButton.click();
    WebElement repo = driver.findElement(By.xpath(
        "/html/body/div[1]/div[5]/div/aside/div/loading-context/div/div[1]/div/ul/li[2]/div/div/a"));
    repo.click();
